Je m'excuse pour la confusion précédente. Sur GitHub, vous pouvez utiliser du HTML pour centrer des éléments dans un fichier README.md. Voici comment vous pourriez le faire en utilisant du code HTML pour centrer les éléments :

```html
<div style="text-align:center;">

![Logo](/media/image_univ.jpg)
