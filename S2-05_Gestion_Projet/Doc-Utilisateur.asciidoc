...
[[ChampsClients]]
* [red]#Nom du client#
* [green]#Prénom du client#
* [blue]#L'adresse du client#
* [lime]#Le numéro de télephone du client#
* [fuchsia]#L'E-mail du client#

Certains champs ne peuvent être définis comme:

* [olive]#L'ID du client généré par la base de données#
* [gray]#Si le client est actif ou non car si il est crée il doit être actif#
...
Vous devez ensuite sélectionner le client dont vous voulez modifier les informations dans la [red]#liste#. 
...
* [green]#`Modifier` pour confirmer les changements#
* [red]#`Annuler` pour abandonner les changements#
...
image:{tuto}AfficherPrelev/4-Etape.png[Etape4]
...
image:{tuto}AfficherPrelev/5-Etape.png[Etape5]
...
* [red]#`Annuler` les changements#
* [green]#`Valider` les changements#
...
Une fenêtre de confirmation s'ouvre alors, sélectionnez simplement si vous souhaitez confirmer `Ok` ou `Annuler`.
